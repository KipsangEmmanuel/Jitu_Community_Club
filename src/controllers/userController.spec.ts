...
describe('Jitu Community Club Controller Tests', () => {
  ...
  describe('updateUser', () => {
    ...
    it('should update user successfully', async () => {
      ...
      jest.spyOn(mssql, 'connect' as any).mockResolvedValue(mockedPool);
  ...
  describe('registerUser', () => {
    it('should register user successfully', async () => {
      const req = {
        body: { username: 'Emmanuel kipsang', password: 'password123', email: 'emmanuel.kipsang@thejitu.com' },
      } as unknown as Request;
  ...
  describe('getMember', () => {
    ...
    it('should get member successfully', async () => {
      ...
      const mockedExecuteResult = { recordset: [{ id: 'someId', username: 'Emmanuel Kipsang', email: 'emmanuel@example.com' }] };
